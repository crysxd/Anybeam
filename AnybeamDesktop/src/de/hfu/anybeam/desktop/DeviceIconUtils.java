	...
	public static ImageIcon getIconForDeviceType(DeviceType type) {
		...
		case TYPE_SMARTPHONE:
			...
			return new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					SearchWindow.class.getResource("/drawable/ic_device_phone.png")),
					language.getString("descriptionSmartphone"));
		case TYPE_TABLET:
			// Selects Tablet Icon
			return new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					SearchWindow.class.getResource("/drawable/ic_device_tablet.png")),
					language.getString("descriptionTablet"));
		case TYPE_LAPTOP:
			// Selects Laptop Icon
			return new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					SearchWindow.class.getResource("/drawable/ic_device_laptop.png")),
					language.getString("descriptionLaptop"));
		case TYPE_DESKTOP:
			// Selects Computer Icon
			return new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					SearchWindow.class.getResource("/drawable/ic_device_computer.png")),
					language.getString("descriptionDesktop"));

		default:
			// Selects Device Unknown Icon
			return new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					SearchWindow.class.getResource("/drawable/ic_device_unknown.png")),
